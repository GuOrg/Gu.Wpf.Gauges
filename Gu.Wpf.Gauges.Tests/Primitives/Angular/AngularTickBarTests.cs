namespace Gu.Wpf.Gauges.Tests.Primitives.Angular
{
    ...
    public class AngularTickBarTests
    {
        ...
        [TestCase(true, 1, 1, "0 0 0 0", "0,0.5,0,0.5")]
        [TestCase(true, 2, 1, "0 0 0 0", "0,1.5,0,1.5")]
        [TestCase(true, 2, 0, "0 1 0 1", "0,0,0,0")]
        [TestCase(true, 2, 1, "0 1 0 1", "0,0.5,0,0.5")]
        [TestCase(true, 3, 1, "0 1 0 1", "0,1,0,1")]
        [TestCase(false, 1, 1, "0 0 0 0", "0,0.5,0,0.5")]
        [TestCase(false, 2, 1, "0 0 0 0", "0,1.5,0,1.5")]
        [TestCase(false, 2, 0, "0 1 0 1", "0,0,0,0")]
        [TestCase(false, 2, 1, "0 1 0 1", "0,0.5,0,0.5")]
        ...
        [TestCase(true, 2, 1, "0 1 0 1", "0,0.5,0,0.5")]
        [TestCase(true, 3, 1, "0 1 0 1", "0,1,0,1")]
        [TestCase(false, 1, 1, "0 0 0 0", "0.5,0,0.5,0")]
        [TestCase(false, 2, 1, "0 0 0 0", "1.5,0,1.5,0")]
        [TestCase(false, 2, 0, "1 0 1 0", "0,0,0,0")]
        [TestCase(false, 2, 1, "1 0 1 0", "0.5,0,0.5,0")]
        [TestCase(false, 3, 1, "1 0 1 0", "1,0,1,0")]
        [TestCase(true, 1, 1, "0 0 0 0", "0.5,0,0.5,0")]
        [TestCase(true, 2, 1, "0 0 0 0", "1.5,0,1.5,0")]
